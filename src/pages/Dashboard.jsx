...
/* CARD */
const Card = ({ title, value, icon, trend, danger }) => {
  return (
    <motion.div
    ...
    >
      ...
      <div className="relative z-10 flex justify-between items-start gap-3">
        ...
        <div
          className={`
            h-14 w-14 rounded-2xl flex items-center justify-center text-xl
            ${
              danger
                ? "bg-red-500/10 text-red-500"
                : "bg-gray-200 dark:bg-white/5 text-black dark:text-white"
            }
          `}
        >
          {icon}
